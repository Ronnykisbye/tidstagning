...
(function(app){
  ...
  function seed(data){
    if((data.demoSeedVersion||0)>=4)return data;
    const customers=[
    ...
    const employees=[
      {id:'demo-employee-ronny',name:'Ronny Kisbye',email:'ronny@demo-firma.example',phone:'20 00 00 00',role:'Chef',active:true},
